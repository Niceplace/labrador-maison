...
echo ""
echo "Next steps:"
echo "1. Copy the htpasswd file to thinkcenter:"
echo "   scp $HTPASSWD_FILE thinkcenter:~/workspace/personal/labrador-maison/reverse-proxy-traefik/auth/"
echo "2. Restart Traefik and registry services on thinkcenter:"
echo "   ssh thinkcenter 'cd ~/workspace/personal/labrador-maison/reverse-proxy-traefik && docker-compose up -d'"
